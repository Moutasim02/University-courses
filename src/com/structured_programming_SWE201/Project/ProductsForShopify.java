...
public class ProductsForShopify extends ShopifyCLI{
    ...
    public ProductsForShopify(String id, String name, float price, String department) {
        super(); //Invoking the parent class constructor which looks like this: 
                // ProductsForShopify();
        this.id = id;
        this.name = name;
        this.price = price;
...
ProductsForShopify [] p = new ProductsForShopify[21];
