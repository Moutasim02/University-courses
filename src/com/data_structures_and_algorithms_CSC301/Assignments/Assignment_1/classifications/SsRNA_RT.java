...
public class SsRNA_RT extends Virus {
    public SsRNA_RT() {
    }

    public SsRNA_RT(String virusName, String symptoms, String bodySample, String bodySystemEffect, String virusDiscoveredBy, int virusDiscoveryYear) {
