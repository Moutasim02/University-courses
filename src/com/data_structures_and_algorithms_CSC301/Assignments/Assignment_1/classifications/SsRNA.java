...
public class SsRNA extends Virus {
    public SsRNA() {
    }

    public SsRNA(String virusName, String symptoms, String bodySample, String bodySystemEffect, String virusDiscoveredBy, int virusDiscoveryYear) {
