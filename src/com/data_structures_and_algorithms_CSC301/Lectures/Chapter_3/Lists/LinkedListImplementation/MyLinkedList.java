package com.data_structures_and_algorithms_CSC301.Lectures.Chapter_3.Lists.LinkedListImplementation;

import com.data_structures_and_algorithms_CSC301.Lectures.Chapter_3.Lists.ArrayListImplementation.MyArrayList;
...
public class MyLinkedList<E> extends MyArrayList<E> {
    ...
    public void addFirst(E e) {
        MyNode<E> newNode = new MyNode<>(e); // Create a new node
    ...
    public void addLast(E e) {
        MyNode<E> newNode = new MyNode<>(e); // Create a new node for e
        if (tail == null)
            head = tail = null; // The only node in list
        else {
            tail.next = newNode; // Link the new node with the last nod
    ...
    public E removeFirst() {
        if (size == 0) return null; // Nothing to delete
            ...
            MyNode<E> temp = head; // Keep the first node temporarily
            head = head.next; // Move head to point to next node
            size--; // Reduce size by 1
            if (size == 0) tail = null; // List becomes empty
     ...
     * in this list. Return -1 if on match. */
    ...
    private class LinkedListIterator implements Iterator<E> {
        private MyNode<E> current = head; // Current index
